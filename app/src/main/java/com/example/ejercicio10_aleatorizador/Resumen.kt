package com.example.ejercicio10_aleatorizador
...
import com.example.ejercicio10_aleatorizador.ejercicio10.Dado
import com.example.ejercicio10_aleatorizador.databinding.ActivityResumenBinding
    ...
    fun botones (binding: ActivityResumenBinding){
        ...
        binding.continuar.setOnClickListener {
            if (binding.editText.text.isEmpty()){
                ...
                intent= Intent(this, Dado::class.java)
